...
def get_a2a_routes(fqdn: str):
    skill = AgentSkill(
        id="google_maps_navigator",
        name="TARUMT Route and Navigation Planner",
        description="A specialized assistant for calculating routes, distances, and travel times.",
        tags=["navigation", "maps", "routing"],
        examples=["How long does it take to drive from Subang to TARUMT Setapak?"],
    )

    agent_card = AgentCard(
        name="TARUMT Maps Agent",
        description="Navigation assistant for TARUMT students",
        url=fqdn,
        version="1.0.0",
