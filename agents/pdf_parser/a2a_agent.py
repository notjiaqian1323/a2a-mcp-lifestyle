...
def get_a2a_routes(fqdn: str):
    skill = AgentSkill(
        id="pdf_document_parser",
        name="TARUMT PDF Parser",
        description="Extracts raw text and tables from PDF files into Markdown.",
        tags=["pdf", "ocr", "markdown", "timetable"],
        examples=["Can you parse this timetable PDF?"],
    )
    ...
    agent_card = AgentCard(
        ...
        url=fqdn,
        version="1.0.0",
        defaultInputModes=["text", "file"], # Important: Tell the system it accepts files!
